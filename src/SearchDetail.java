...
public class SearchDetail
{
    public static void main( String[] ar )
    {
        ...
        String url = "http://www.ncbi.nlm.nih.gov/nucleotide/723677642";

        HttpClient httpClient = HttpClientBuilder.create().build();
        HttpPost post = new HttpPost( url );
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        
        params.add( new BasicNameValuePair("report", "genbank") );
            ...
            String str = httpClient.execute(post, new BasicResponseHandler() 
            {
                        ...
                        throws HttpResponseException, IOException
                {
                    ...
                    for( Element row : rows )
                    {
                        ...
                        sb.append( "getSeqGi : " ).append( row.getElementById( "chk_" + rowNum ).text() );
